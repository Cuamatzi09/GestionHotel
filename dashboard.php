    ...
    <div class="col-md-4">
        <div class="card mb-4">
            ...
            <div class="card-body text-center">
                <div class="mb-3">
                    <img src="<?php echo SITE_URL; ?>/assets/images/default-avatar.png" alt="Avatar" class="rounded-circle" width="120">
                </div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="list-group">
                    <a href="profile.php?action=password" class="list-group-item list-group-item-action">
                        <i class="fas fa-lock me-2"></i> Cambiar Contraseña
                    </a>
                    <a href="profile.php?action=email" class="list-group-item list-group-item-action">
                        <i class="fas fa-envelope me-2"></i> Actualizar Correo Electrónico
                    </a>
                    <a href="profile.php?action=phone" class="list-group-item list-group-item-action">
